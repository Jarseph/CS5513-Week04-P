...
const dataURL = "https://dev-friendlyeats.pantheonsite.io/wp_json/twentytwentyfive-child/v1/latest-posts/1";
...
// if you use acf without custom tables, we need transform what is a big string
  // inside acf_fields and make it JSON
  // loop thru each object in array returned as JSON
  // so in your jsx you will use dot notation to get into acf_fields:
  // acf_fields.purchase_date
  jsonObj.forEach(
    function(item) {
